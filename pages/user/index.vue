        ...
        <div class="shadow-md my-10 shadow-black/30 rounded-lg text-black/50 flex flex-col  gap-5 justify-center py-5 px-5">
            <div class="px-3">
                ...
                <div class="flex items-center mb-1">
                    <input type="text"
                        :value="`https://neptoasset.com/auth/register/${account.profile.user.username}`"
                        class="outline-none border py-3 w-full ps-3 bg-slate-200">
                    <a :href="'https://www.shareaholic.com/api/share/?v=1&amp;apitype=1&amp;apikey=2a8a59ebb34e71168adaf4902b2e4180&amp;service=copy_link&amp;title=Nepto Assets&amp;link=https://neptoasset.com/auth/register/' + account.profile.user.username"
                ...
                <p>
                    ...
                    <a :href="'https://www.shareaholic.com/api/share/?v=1&amp;apitype=1&amp;apikey=2a8a59ebb34e71168adaf4902b2e4180&amp;service=facebook&amp;title=Nepto Assets&amp;link=https://neptoasset.com/auth/register/' + account.profile.user.username"
                        target="_blank">
                        <i class="fa-brands fa-facebook material-icon m-1  w3-border w3-round-large  w3-hover-blue p-1"></i>
                    </a>
                    <a :href="'https://www.shareaholic.com/api/share/?v=1&amp;apitype=1&amp;apikey=2a8a59ebb34e71168adaf4902b2e4180&amp;service=whatsapp&amp;title=Nepto Assets&amp;link=https://neptoasset.com/auth/register/' + account.profile.user.username"
                        target="_blank">
                        <i class="fa-brands fa-whatsapp material-icon m-1 w3-border w3-round-large  w3-hover-blue p-1"></i>
                    </a>
                    <a :href="'https://www.shareaholic.com/api/share/?v=1&amp;apitype=1&amp;apikey=2a8a59ebb34e71168adaf4902b2e4180&amp;service=telegram&amp;title=Nepto Assets&amp;link=https://neptoasset.com/auth/register/' + account.profile.user.username"
                        target="_blank">
                        <i class="fa-brands fa-telegram m-1 material-icon w3-border w3-round-large w3-hover-blue p-1"></i>
                    </a>
                    <a :href="'https://www.shareaholic.com/api/share/?v=1&amp;apitype=1&amp;apikey=2a8a59ebb34e71168adaf4902b2e4180&amp;service=twitter&amp;title=Nepto Assets&amp;link=https://neptoasset.com/auth/register/' + account.profile.user.username"
                        target="_blank">
